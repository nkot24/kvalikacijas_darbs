...
class ProcessController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('processes.create', ['users' => $users]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $process = Process::create(['processa_nosaukums' => $data['processa_nosaukums']]);
    ...
    public function update(Request $request, Process $process)
    {
        if ($request->filled('swap')) {
            return $this->handleSwap($request, $process);
        }

        $data = $this->validateProcess($request);

        $process->update(['processa_nosaukums' => $data['processa_nosaukums']]);
    ...
    private function handleSwap(Request $request, Process $process)
    {
    ...
    private function swapProcessIds(int $idA, int $idB): void
    {
        ...
        DB::transaction(function () use ($idA, $idB) {
            ...
            foreach (['process_user', 'tasks', 'process_progresses', 'process_files'] as $table) {
