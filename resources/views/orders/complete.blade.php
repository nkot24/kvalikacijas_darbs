<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-full mx-auto">
            ...
            {{-- Top Controls Card (same as template) --}}
            ...
            {{-- Table Card (same as index, but: phone scroll YES / PC scroll NO + clips overflow) --}}
            <div class="overflow-hidden overflow-x-auto lg:overflow-x-hidden mx-2 sm:mx-4 lg:mx-[100px] rounded-2xl border border-white/10 bg-white/5 backdrop-blur shadow-xl">
                    ...
                    <tbody class="divide-y divide-white/10">
                        @forelse ($orders as $order)
                            ...
                            >
                                ...
                                <td class="px-4 py-3 max-w-[240px] truncate text-slate-200 hidden lg:table-cell">
                                ...
                                <td class="px-4 py-3 max-w-[180px] truncate text-slate-200 hidden md:table-cell">
                                    {{ $order->izpildes_datums }}
                                </td>

                                <td class="px-4 py-3 max-w-[140px] truncate text-slate-200 hidden lg:table-cell">
                                    {{ $order->prioritāte }}
                                </td>
                                ...
                                <td class="px-4 py-3 max-w-[260px] truncate text-slate-300 hidden xl:table-cell">
                                    {{ $order->piezimes ?? '-' }}
                                </td>
                            </tr>
                        @empty
